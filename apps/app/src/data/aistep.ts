  ...
  },
  {
    ...
    options: [
      ...
      },
      {
        ...
        category: "Architecture",
        love: ["express", "react", "zustand", "nextjs"],
        hate: []
      },
      {
        id: "cli",
      ...
      },
      {
        ...
        category: "Architecture",
        love: ["plain-css"],
        hate: ["category=Backend Framework", "category=authentication", "category=Frontend Framework", "category=Database", "category=ORM/ODM", "category=State Management", "category=testing", "category=Development Tools"]
      },
      {
        id: "serverless",
